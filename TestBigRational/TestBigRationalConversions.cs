...
{
	public TestContext TestContext { get => m_testContext; set { m_testContext = value; } }
	private TestContext m_testContext;

	[Test]
	public void TestConvertFromDecimalPointFloat()
	{
		var negativeOneAndOneHalf = -3f / 2f;
		var oneThird = 1f / 3f;

		var expectedValue1 = new BigRational(-1, new Fraction(1, 2));
		var result1 = (BigRational)negativeOneAndOneHalf;

		var expectedValue2 = new BigRational(0, new Fraction(1, 3));
		var result2 = (BigRational)oneThird;
	...
	{
		var fifteenSixteenths = 0.9375d;

		var expectedValue = new BigRational(BigInteger.Zero, new Fraction(15, 16));
		var result = (BigRational)fifteenSixteenths;
